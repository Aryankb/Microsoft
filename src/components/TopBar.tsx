...
export default function TopBar({
  ...
  const handlePremadeWorkflows = () => {
    navigate("/premade-workflows");
  };
            ...
            <div className="mx-4 flex items-center">
              <span
                className={`workflow-name ${
                  animateWorkflowName ? "animate-fade-in" : ""
                }`}
              >
                {currentWorkflow.name}
              </span>
            ...
            <button
              ...
              onClick={
                item.label === "Add Auth"
                  ...
                  ? handleCreateTool
                  : item.label === "Your Collections"
                  ? handlePremadeWorkflows
                  : undefined
              }
            >
              <item.icon size={20} />
