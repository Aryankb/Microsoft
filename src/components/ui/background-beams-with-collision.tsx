  ...
  return (
    <>
      <motion.div
        ...
        style={{
          background: "linear-gradient(to top, #00ADB5, #FF6B6B, transparent)",
          position: "absolute",
          left: 0,
          top: "20%",
          margin: "auto",
  ...
  return (
    <div {...props} className={cn("absolute z-50 h-2 w-2", props.className)}>
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(to right, transparent, #00ADB5, transparent)",
          position: "absolute",
          insetInline: "-2.5rem",
          top: 0,
          margin: "auto",
      ...
      {spans.map((span) => (
        <motion.span
          ...
          style={{
            ...
            width: "4px",
            borderRadius: "9999px",
            background: "linear-gradient(to bottom, #00ADB5, #FF6B6B)",
          }}
        />
      ))}
    </div>
